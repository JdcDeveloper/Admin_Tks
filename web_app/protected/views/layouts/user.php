      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li> <a href="dashboard/area"><i class="fa fa-circle-o"></i> Area</a></li>
              <li> <a href="dashboard/map"><i class="fa fa-circle-o"></i> Map</a></li>
           <!--  <li ><a href="index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li> -->
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="projects/view"><i class="fa fa-circle-o"></i> View </a></li>
            <li><a href="projects/add""><i class="fa fa-circle-o"></i> Add </a></li>             
          </ul>  
        </li>
